...
class FloridaCenterScreen extends StatefulWidget {
  const FloridaCenterScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _FloridaCenterScreenState createState() => _FloridaCenterScreenState();
}

class _FloridaCenterScreenState extends State<FloridaCenterScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 3);
    loadParkingLotName(3);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 3),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 3),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 3),
                ),
              ],
            ),
          ),
