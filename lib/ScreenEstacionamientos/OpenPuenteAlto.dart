...
class OpenPuenteAltoScreen extends StatefulWidget {
  const OpenPuenteAltoScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _OpenPuenteAltoScreenState createState() => _OpenPuenteAltoScreenState();
}

class _OpenPuenteAltoScreenState extends State<OpenPuenteAltoScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 18);
    loadParkingLotName(18);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 18),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 18),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 18),
                ),
              ],
            ),
          ),
