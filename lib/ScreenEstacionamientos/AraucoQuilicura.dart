...
class AraucoQuilicuraScreen extends StatefulWidget {
  const AraucoQuilicuraScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _AraucoQuilicuraScreenState createState() => _AraucoQuilicuraScreenState();
}

class _AraucoQuilicuraScreenState extends State<AraucoQuilicuraScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 23);
    loadParkingLotName(23);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 23),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 23),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 23),
                ),
              ],
            ),
          ),
