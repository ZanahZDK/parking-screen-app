...
class CostaneraCenterScreen extends StatefulWidget {
  const CostaneraCenterScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CostaneraCenterScreenState createState() => _CostaneraCenterScreenState();
}

class _CostaneraCenterScreenState extends State<CostaneraCenterScreen> {
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 1),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 1),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 1),
                ),
              ],
            ),
          ),
