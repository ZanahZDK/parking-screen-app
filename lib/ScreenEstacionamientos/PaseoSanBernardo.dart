...
class PaseoSanBernardoScreen extends StatefulWidget {
  const PaseoSanBernardoScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _PaseoSanBernardoScreenState createState() => _PaseoSanBernardoScreenState();
}

class _PaseoSanBernardoScreenState extends State<PaseoSanBernardoScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 16);
    loadParkingLotName(16);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 16),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 16),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 16),
                ),
              ],
            ),
          ),
