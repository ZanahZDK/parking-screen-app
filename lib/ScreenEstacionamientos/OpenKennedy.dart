...
class OpenKennedyScreen extends StatefulWidget {
  const OpenKennedyScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _OpenKennedyScreenState createState() => _OpenKennedyScreenState();
}

class _OpenKennedyScreenState extends State<OpenKennedyScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 10);
    loadParkingLotName(10);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 10),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 10),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 10),
                ),
              ],
            ),
          ),
