...
class AraucoMaipuScreen extends StatefulWidget {
  const AraucoMaipuScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _AraucoMaipuScreenState createState() => _AraucoMaipuScreenState();
}

class _AraucoMaipuScreenState extends State<AraucoMaipuScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 22);
    loadParkingLotName(22);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 22),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 22),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 22),
                ),
              ],
            ),
          ),
