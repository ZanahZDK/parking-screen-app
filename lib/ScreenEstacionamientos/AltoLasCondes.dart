...
class AltoLasCondesScreen extends StatefulWidget {
  const AltoLasCondesScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _AltoLasCondesScreenState createState() => _AltoLasCondesScreenState();
}

class _AltoLasCondesScreenState extends State<AltoLasCondesScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 11);
    loadParkingLotName(11);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 11),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 11),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 11),
                ),
              ],
            ),
          ),
