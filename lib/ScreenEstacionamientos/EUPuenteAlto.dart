...
class EUPuenteAltoScreen extends StatefulWidget {
  const EUPuenteAltoScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _EUPuenteAltoScreenState createState() => _EUPuenteAltoScreenState();
}

class _EUPuenteAltoScreenState extends State<EUPuenteAltoScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 19);
    loadParkingLotName(19);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 19),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 19),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 19),
                ),
              ],
            ),
          ),
