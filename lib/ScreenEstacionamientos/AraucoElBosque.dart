...
class AraucoElBosqueScreen extends StatefulWidget {
  const AraucoElBosqueScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _AraucoElBosqueScreenState createState() => _AraucoElBosqueScreenState();
}

class _AraucoElBosqueScreenState extends State<AraucoElBosqueScreen> {
  ...
  void initState() {
    super.initState();
    loadParkingSpaces('Nivel 1', 20);
    loadParkingLotName(20);
  }
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: floorButton('Nivel 1', 20),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 2', 20),
                ),
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 50.0), // Ajusta el padding como desees
                  child: floorButton('Nivel 3', 20),
                ),
              ],
            ),
          ),
